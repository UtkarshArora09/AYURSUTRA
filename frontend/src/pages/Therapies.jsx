  ...
  />
      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6 flex-grow flex flex-col">
        ...
        <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4 border-t border-gray-100 mt-auto">
          ...
          <button className="w-full sm:flex-1 h-11 sm:h-12 border-2 border-green-500 text-green-600 hover:bg-green-50 rounded-xl font-semibold transition-all duration-300 flex items-center justify-center text-sm sm:text-base">
            Book Session
          </button>
        </div>
      </div>
