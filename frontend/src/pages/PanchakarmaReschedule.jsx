...
const PanchakarmaReschedule = () => {
  ...
  const fetchRescheduleDates = async () => {
    ...
    setTimeout(() => {
      ...
      for (let i = 3; i <= 30; i++) { // Start from 3 days ahead
  ...
  const fetchTimeSlots = async (date) => {
    ...
    setTimeout(() => {
      ...
      const optimalSlots = doshaOptimalTimes[appointmentData.doshaType] || baseSlots;
  ...
  const canPerformAction = (actionType, appointment) => {
    ...
    const deadline = actionType === 'reschedule' ? appointment.rescheduleDeadline : appointment.cancellationDeadline;
            ...
            {step === 1 && (
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-8">
                  Enter any one of the following details to locate your appointment
                </p>
                ...
                <form onSubmit={handleSearch} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setSearchData(prev => ({...prev, bookingId: e.target.value}))}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setSearchData(prev => ({...prev, aadharNumber: e.target.value}))}
                  ...
                  <button
                    type="submit"
                    disabled={!searchData.bookingId && !searchData.patientId && !searchData.mobileNumber && !searchData.aadharNumber}
              ...
              <div className="p-8">
                ...
                <div className={`mb-6 p-4 rounded-lg flex items-center ${
                  ...
                  <span className="font-semibold">
                    Status: {appointmentData.status.charAt(0).toUpperCase() + appointmentData.status.slice(1)}
                  </span>
                  <span className="ml-4 text-sm">
                    {getDaysUntilAppointment(appointmentData.currentDate)} days until appointment
                  </span>
                </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      <div>
                        ...
                        <p className="font-mono font-semibold">{appointmentData.bookingId}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{appointmentData.mobileNumber}</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="font-semibold">
                            {new Date(appointmentData.currentDate).toLocaleDateString('en-US', { 
                              weekday: 'long', 
                              year: 'numeric', 
                              month: 'long', 
                              day: 'numeric' 
                      ...
                      <div className="flex items-center">
                        ...
                        <div>
                          ...
                          <p className="font-semibold">{appointmentData.currentTime}</p>
                        </div>
                      </div>
                      <div>
                        <span className="text-gray-600 text-sm">Treatment:</span>
                        <p className="font-semibold">{appointmentData.treatment.name}</p>
                        <p className="text-sm text-gray-500">{appointmentData.treatment.duration}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div className="bg-green-50 rounded-lg p-6">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      />
                      <div>
                        <p className="font-semibold">{appointmentData.doctor.name}</p>
                  ...
                  <div className="bg-purple-50 rounded-lg p-6">
                    <h3 className="text-lg font-semibold mb-4">Treatment Center</h3>
                    <p className="font-semibold">{appointmentData.center.name}</p>
                    <p className="text-sm text-gray-600">{appointmentData.center.address}</p>
                  </div>
                </div>
                  ...
                  >
                    <div className="flex items-center mb-4">
                      <ArrowPathIcon className={`w-8 h-8 mr-3 ${
                        canPerformAction('reschedule', appointmentData) ? 'text-blue-600' : 'text-gray-400'
                      }`} />
                      <h3 className="text-xl font-semibold text-gray-800">Reschedule Appointment</h3>
                    </div>
                    <p className="text-gray-600 mb-4">
                      Change your appointment date and time while keeping the same doctor and treatment.
                    </p>
                    {canPerformAction('reschedule', appointmentData) ? (
                      <div className="text-sm text-green-600">
                        ✓ Available until {new Date(appointmentData.rescheduleDeadline).toLocaleDateString()}
                      </div>
                    ) : (
                      <div className="text-sm text-red-600">
                        ✗ Reschedule deadline passed ({new Date(appointmentData.rescheduleDeadline).toLocaleDateString()})
                      </div>
                    )}
                  </div>
                  ...
                  >
                    <div className="flex items-center mb-4">
                      <XCircleIcon className={`w-8 h-8 mr-3 ${
                        canPerformAction('cancel', appointmentData) ? 'text-red-600' : 'text-gray-400'
                      }`} />
                      <h3 className="text-xl font-semibold text-gray-800">Cancel Appointment</h3>
                    </div>
                    <p className="text-gray-600 mb-4">
                      Cancel your appointment completely. This action cannot be undone.
                    </p>
                    {canPerformAction('cancel', appointmentData) ? (
                      <div className="text-sm text-green-600">
                        ✓ Available until {new Date(appointmentData.cancellationDeadline).toLocaleDateString()}
                      </div>
                    ) : (
                      <div className="text-sm text-red-600">
                        ✗ Cancellation deadline passed ({new Date(appointmentData.cancellationDeadline).toLocaleDateString()})
                      </div>
                    )}
                  </div>
                </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="text-sm text-yellow-800">
                      ...
                      <ul className="space-y-1">
                        <li>• Reschedule: Available up to 2 days before appointment</li>
                        <li>• Cancellation: Available up to 1 day before appointment</li>
                ...
                <form onSubmit={handleReschedule} className="space-y-8">
                  ...
                  <div className="bg-gray-50 rounded-lg p-4">
                    ...
                    <div className="flex items-center text-sm text-gray-600">
                      ...
                      <span>{new Date(appointmentData.currentDate).toLocaleDateString()}</span>
                        ...
                        {availableDates.map((date) => {
                          ...
                          return (
                            <div
                              key={date}
                              onClick={() => {
                                setRescheduleData(prev => ({...prev, newDate: date}));
                                fetchTimeSlots(date);
                              }}
                      ...
                      {loading ? (
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
                          {availableSlots.map((slot) => (
                            <div
                              key={slot.time}
                              onClick={() => slot.available && setRescheduleData(prev => ({...prev, newTimeSlot: slot}))}
                              className={`p-4 border-2 rounded-lg transition-all ${
                                !slot.available
                                  ? 'border-gray-200 bg-gray-50 cursor-not-allowed opacity-50'
                                  : rescheduleData.newTimeSlot?.time === slot.time
                            ...
                            >
                              ...
                              <div className="text-xs text-gray-500">{slot.therapyDuration}</div>
                              {slot.optimal && (
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setRescheduleData(prev => ({...prev, preferences: e.target.value}))}
                      rows={3}
                  ...
                  <div className="flex justify-between">
                    ...
                    <button
                      type="submit"
                      disabled={!rescheduleData.newDate || !rescheduleData.newTimeSlot || !rescheduleData.reason || loading}
            ...
            {step === 4 && action === 'cancel' && (
              <div className="p-8">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700">
                        This action will permanently cancel your appointment. Please ensure this is what you want to do.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <form onSubmit={handleCancel} className="space-y-6">
                  {/* Appointment Summary */}
                  <div className="bg-gray-50 rounded-lg p-4">
                    <h3 className="font-semibold text-gray-800 mb-2">Appointment to Cancel</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                      <div>
                        <span className="text-gray-600">Date:</span>
                        <p className="font-semibold">{new Date(appointmentData.currentDate).toLocaleDateString()}</p>
                      </div>
                      <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => setCancelData(prev => ({...prev, feedback: e.target.value}))}
                      rows={4}
                ...
                <div className="mb-8">
                  {action === 'reschedule' ? (
                    <>
                      ...
                      <h2 className="text-3xl font-bold text-green-800 mb-4">Appointment Rescheduled!</h2>
                      <p className="text-lg text-gray-600 mb-8">
                        Your appointment has been successfully rescheduled.
                      </p>
                      
                      <div className="bg-green-50 border border-green-200 rounded-lg p-6 max-w-md mx-auto mb-8">
                        <h3 className="font-semibold text-green-800 mb-4">New Appointment Details</h3>
                        <div className="text-left space-y-2">
                          <p><span className="text-gray-600">New Date:</span> <span className="font-semibold">{new Date(rescheduleData.newDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span></p>
                          <p><span className="text-gray-600">New Time:</span> <span className="font-semibold">{rescheduleData.newTimeSlot?.time}</span></p>
                          <p><span className="text-gray-600">Doctor:</span> <span className="font-semibold">{appointmentData.doctor.name}</span></p>
                          <p><span className="text-gray-600">Treatment:</span> <span className="font-semibold">{appointmentData.treatment.name}</span></p>
                        </div>
                      </div>
                    </>
                  ) : (
                    <>
                      ...
                      <h2 className="text-3xl font-bold text-red-800 mb-4">Appointment Cancelled</h2>
                      <p className="text-lg text-gray-600 mb-8">
                        Your appointment has been cancelled successfully.
                      </p>
                      
                      <div className="bg-red-50 border border-red-200 rounded-lg p-6 max-w-md mx-auto mb-8">
                        <h3 className="font-semibold text-red-800 mb-4">Cancelled Appointment</h3>
                        <div className="text-left space-y-2">
                          <p><span className="text-gray-600">Original Date:</span> <span className="font-semibold">{new Date(appointmentData.currentDate).toLocaleDateString()}</span></p>
                          <p><span className="text-gray-600">Original Time:</span> <span className="font-semibold">{appointmentData.currentTime}</span></p>
                          <p><span className="text-gray-600">Booking ID:</span> <span className="font-mono font-semibold">{appointmentData.bookingId}</span></p>
                        </div>
                      </div>
                    </>
                  )}
                  ...
                  <div className="flex justify-center space-x-4">
                    ...
                    <button
                      onClick={() => {
                        ...
                        setSearchData({bookingId: '', patientId: '', mobileNumber: '', aadharNumber: ''});
                        setRescheduleData({newDate: '', newTimeSlot: null, reason: '', preferences: ''});
